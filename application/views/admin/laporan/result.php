...
<div class="right_col" role="main">
    <h2>Hasil Laporan Transaksi Bulanan</h2>
    ...
    <section class="content">
	  ...
	  <!-- <div class="box"> -->
		...
		<div class=row>
						...
						<div class='col-md-8'>&nbsp;&nbsp;&nbsp;&nbsp;
						<div class="btn-group">
							<?php echo anchor('laporan/add?month='.$month.'&&year='.$year.'',
							'<button  style="margin-top: 28px;" type="button" class="btn btn-success btn-flat" data-toggle="tooltip" data-placement="top" title="Cetak Laporan"><i class="fa fa-print"></i> Cetak</button>' );?>
							</div>
							</div>
