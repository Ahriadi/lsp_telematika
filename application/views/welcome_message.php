              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Data Pesanan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Pesanan Masuk</a></li>
                      <li><a href="form_advanced.html">Pesanan diproses</a></li>
                      <li><a href="form_validation.html">Transaksi Selesai</a></li>
                      </ul>
                  </li>
                  <li><a><i class="fa fa-print"></i>Laporan <span ></span></a>
                  </li>
